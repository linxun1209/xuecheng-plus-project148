...
import com.xuecheng.checkcode.model.PhoneCodeParamsDto;
...
public class CheckCodeController {
    ...
    public Boolean email(PhoneCodeParamsDto phoneCodeParamsDto){
        Boolean isSuccess = picCheckCodeService.Findemail(phoneCodeParamsDto);
        return isSuccess;
    }
}
